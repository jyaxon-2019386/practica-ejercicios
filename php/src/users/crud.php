            ...
            switch ($quest) {
                case 'ingresar_usuario':
                    ...
                    if(!validar_usuario($usuario)){
                        header('HTTP/1.1 400 Bad Request');
                        echo json_encode([
                            'error' => 'El nombre de usuario solo puede tener letras, número o guiones bajos.'
                        ]);
                        break;
                    }
                    ...
                    for ($i = 1; ; $i++) { // Ciclo FOR para crear el numero distintivo del final de usuario nuevo
                        ...
                        $usuario_nuevo = $usuario . $i; // Genera un nuevo nombre de usuario con el numero del final
                    }
